...
| 陳亮祐 | 41143235 | 四資工三乙 | 教室借用系統後端功能開發，如下: 撰寫教室課程資訊爬蟲、爬蟲抓取資料匯入資料庫。 |

---

## 🌐 應用情境

情境一：學生臨時借用教室練習報告或排練表演
小組報告或期末表演前夕，學生臨時需要空教室進行討論與練習。透過系統查詢當天空教室時段後，立即提出借用申請，並經由系統管理員線上核可，即可快速取得使用權，節省來回詢問時間。

情境二：老師規劃課外活動或加開課程時借用教室
鄭老師想安排一場課後補課或辦理一場專題講座，需要額外教室空間。透過系統登入後，可直接查看適合時段與空間的可用教室，並快速完成申請與公告流程，避免與其他活動衝突。

情境三：系辦管理員統整與審核教室使用狀況
管理員可使用系統後台功能，統一管理每日教室借用申請，審核使用用途是否合理，並可檢視即時教室使用情況、彙整借用紀錄與統計報表，有效提升資源分配與管理效率。
...
- 使用者編號：須為「虎尾科技大學」學生之學號，共 8 碼，或是教師員工號碼，共6碼。  
  學生學號:  
　　　第一碼: 學制，如:1 為碩士、3 為二技、4 為四技、5 為五專。  
　　　第二、三碼: 入學學年，如:11 表示 111 年入學。  
　　　第四、五碼: 系所代碼，如:資工系為 43。  
　　　第六碼: 班級代碼，如:甲班為 1，乙班為 2，依此類推。  
　　　第七、八碼: 學生座號。  
  教師員工編號:  
　　　第一碼:
